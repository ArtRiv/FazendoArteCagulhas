export const InstagramIcon = () => {
    return (
        <a className="animateIcon" target="_blank" href="https://www.instagram.com/fazendoartecagulhas/">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="fill-icon-color mt-1 h-icon-height-normal w-icon-width-normal transition-all duration-300 hover:fill-decoration-pink">
