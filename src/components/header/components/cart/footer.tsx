                                ...
                                return (
                                    <button className="w-full flex flex-col md:flex-row md:justify-between">
                                        <div className="text-ellipsis whitespace-nowrap overflow-hidden flex gap-2">
                                            ...
                                            <span className="text-xs text-font-color/70 font-harmonia leading-line-height-small tracking-letter-space-normal break-words overflow-hidden whitespace-nowrap text-ellipsis antialiased">
