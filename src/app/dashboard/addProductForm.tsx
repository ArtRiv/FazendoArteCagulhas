        ...
        <div className="w-[425px] m-5 flex flex-col gap-5">
            ...
            <form action={formAction} className="flex flex-col gap-2 justify-between text-normal text-font-color/80 font-harmonia leading-line-height-big tracking-letter-space-normal break-words antialiased">
                ...
                <label className="flex gap-4 justify-between">
                    Titulo:
                    <input className="border-2 border-decoration rounded-md" name="title" value={product.title} onChange={handleChange} />
                </label>

                <label className="flex gap-4 justify-between">
                    Tag:
                    <input className="border-2 border-decoration rounded-md" name="tag" value={product.tag} onChange={handleChange} />
                </label>

                <label className="flex gap-4 justify-between">
                    Tipo:
                    <input className="border-2 border-decoration rounded-md" name="type" value={product.type} onChange={handleChange} />
                </label>

                <label className="flex gap-4 justify-between">
                    image link:
                    <input className="border-2 border-decoration rounded-md" name="image" value={product.image} onChange={handleChange} />
                </label>

                <label className="flex gap-4 justify-between">
                    link da shopee:
                    <input className="border-2 border-decoration rounded-md" name="link" value={product.link} onChange={handleChange} />
                </label>

                <label className="flex gap-4 justify-between">
                    preço:
                    <input className="border-2 border-decoration rounded-md" name="price" value={product.price} onChange={handleChange} />
                </label>

                <label className="flex gap-4 justify-between">
                    criado em:
                    <input className="border-2 border-decoration rounded-md" name="created_at" value={product.created_at} onChange={handleChange} />
                </label>

                <label className="flex gap-4 justify-between">
                    numero de compras:
                    <input className="border-2 border-decoration rounded-md" name="purchase_count" value={product.purchase_count} onChange={handleChange} />
                </label>

                <label className="flex gap-4 justify-between">
                    grupo do produto:
                    <input className="border-2 border-decoration rounded-md" name="product_group" value={product.product_group} onChange={handleChange} />
                </label>
